...
import { deleteFlorist } from "@/lib/api/florists";
...
export default function DeleteFloristButton({
    floristId,
    floristName,
}: Props) {
    ...
    async function handleDelete() {
        try {
            ...
            await deleteFlorist(floristId);

            router.push("/admin/florists");
            router.refresh();
        } catch (err) {
            setError(
                err instanceof Error
                    ? err.message
                    : "Não foi possível eliminar a florista.",
            );
